...
//사용자 일반예외(문법적으로 체크 checked exception)
...
//사용자 실행예외(unchecked exception=runtime exception)
...
class A{
 ...
 //예외 던지기 throw:던진 시점에서 예외 발생
 //예외 직접처리
 void abc_1(int num) {
	 try {
	 if(num>70)
		 System.out.println("정상작동");
	 else throw me1;//예외를 던진 이 시점에 예외 발생
	 }
	 catch(MyException e) {System.out.println("예외처리1");}
 }
